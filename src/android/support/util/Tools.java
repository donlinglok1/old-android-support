...
public class Tools {
	...
	public static final JSONArray joinJSONArray(final JSONArray firstArray, final JSONArray secArray) {
	...
	private static final String capitalize(final String string) {
		String result = null;
		if (!It.isNull(string)) {
