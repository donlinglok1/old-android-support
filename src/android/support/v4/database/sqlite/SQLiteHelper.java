...
public class SQLiteHelper extends SQLiteOpenHelper {
     ...
     * @param callback
     */
    public void execute(final String query, final Callback callback) {
     ...
     * @param query
     */
    public void raw(final String query) {
	raw(query, null);
    }
     ...
     * @param callback
     */
    public void raw(final String query, final Callback callback) {
	if (null != callback) {
