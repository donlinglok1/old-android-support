...
public class Glide_CircleTransform extends BitmapTransformation {
	...
	@Override
	public Bitmap transform(final BitmapPool pool, final Bitmap toTransform, final int width, final int height) {
		return circleCrop(pool, toTransform);
	}

	private final Bitmap circleCrop(final BitmapPool pool, final Bitmap source) {
		if (source == null) {
			return null;
		}
		...
		final Bitmap squared = Bitmap.createBitmap(source, width, height, size, size);
