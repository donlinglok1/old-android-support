...
public class ImageResizer extends ImageWorker {
	 ...
	 * @param imageHeight
	 */
	public ImageResizer(final Context context, final int imageWidth, final int imageHeight) {
		super(context);
	 ...
	 * @param imageSize
	 */
	public ImageResizer(final Context context, final int imageSize) {
		super(context);
	 ...
	 * @return
	 */
	private Bitmap processBitmap(final int resId) {
	 ...
	 */
	public static Bitmap decodeSampledBitmapFromResource(final Resources res, final int resId, final int reqWidth,
	 ...
	 *         requested width and height
	 */
	public static Bitmap decodeSampledBitmapFromFile(final String filename, final int reqWidth, final int reqHeight,
	 ...
	 *         requested width and height
	 */
	public static Bitmap decodeSampledBitmapFromDescriptor(final FileDescriptor fileDescriptor, final int reqWidth,
			final int reqHeight, final ImageCache cache) {
	...
	private static void addInBitmapOptions(final BitmapFactory.Options options, final ImageCache cache) {
