...
public abstract class ImageWorker {
	 ...
	 */
	public void addImageCache(final FragmentManager fragmentManager, final ImageCache.ImageCacheParams cacheParams) {
	 ...
	 *            .
	 */
	public void addImageCache(final FragmentActivity activity, final String diskCacheDirectoryName) {
	...
	private class BitmapWorkerTask extends AsyncTask<Void, Void, BitmapDrawable> {
		...
		public BitmapWorkerTask(final Object data, final ImageView imageView) {
			mData = data;
