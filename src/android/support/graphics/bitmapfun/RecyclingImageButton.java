 ...
 * {@link android.widget.Button}, with the standard button background that
 * changes color during different button states. The image on the surface of the
 * button is defined either by the {@code android:src} attribute in the
 * {@code <ImageButton>} XML element or by the {@link #setImageResource(int)}
 * method.
 * </p>
 *
 * <p>
 * To remove the standard button background image, define your own background
 * image or set the background color to be transparent.
 * </p>
 * <p>
 ...
 * orange one for when focused, and a yellow one for when pressed. An easy way
 * to do this is with an XML drawable "selector." For example:
 * </p>
 *
 * <pre>
 ...
 * based on the state of the button and the corresponding images defined in the
 * XML.
 * </p>
 *
 * <p>
 ...
 */
@RemoteView
public class RecyclingImageButton extends RecyclingImageView {
	public RecyclingImageButton(final Context context) {
		this(context, null);
	}

	public RecyclingImageButton(final Context context, final AttributeSet attrs) {
		this(context, attrs, android.R.attr.imageButtonStyle);
	}

	public RecyclingImageButton(final Context context, final AttributeSet attrs, final int defStyle) {
